...
class _GradientExpandableCardState extends State<GradientExpandableCard>
  ...
  Widget build(BuildContext context) {
    return SwipeableTile.card(
      ...
      direction: widget.hasSend ? SwipeDirection.none : SwipeDirection.endToStart,
      ...
      child: GestureDetector(
        onTap: widget.hasSend ? () {} : () { widget.onOpenModal!(); },
        child: Card(
            ...
            children: [
              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: const Color.fromARGB(255, 92, 91, 91).withOpacity(0.05),
                      blurRadius: 3,
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween, // Cambio importante
                  children: [
                    Row(
                      children: [
