...
class ScreenTapas6 extends StatefulWidget {
  const ScreenTapas6({super.key});

  @override
  State<ScreenTapas6> createState() => _ScreenTapas6State();
}

class _ScreenTapas6State extends State<ScreenTapas6> {
